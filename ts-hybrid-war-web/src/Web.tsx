...
export default function Web(props: { apikey: string | undefined, selected_nat: string | undefined }) {
    ...
    props.apikey && fetch('https://api.politicsandwar.com/graphql?api_key=' + props.apikey, {
        ...
        body: JSON.stringify({
            query: `{
            wars(alliance_id:[5875, 622, 1742, 7674, 9927, 4648, 9948, 8804, 5039, 8819, 4729, 5049, 7531,11232,4937],active:true,first:1000){
            data{
  ...
  `
        ...
        .then(res => res.json())
        .then(res => {
            let warring_aas = [5875, 622, 1742, 7674, 9927, 4648, 9948, 8804, 5039, 8819, 4729, 5049, 7531, 11232, 4937]
            let nations = []
